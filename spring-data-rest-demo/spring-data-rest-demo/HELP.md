...
* The original package name 'com.kamal.spring-data-rest-demo' is invalid and this project uses 'com.kamal.spring_data_rest_demo' instead.
...
* [Rest Repositories](https://docs.spring.io/spring-boot/docs/3.2.9/reference/htmlsingle/index.html#howto.data-access.exposing-spring-data-repositories-as-rest)
